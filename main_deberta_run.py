...
if __name__ == "__main__":
    ...
    model = custom_deberta(num_classes=3, dropout=0.2)
    trainer = deberta_trainer(model, train_data, test_data, epochs=10, batch_size=64, learning_rate=1e-5, device=DEVICE, val_dataset=valid_data)
    trainer.train()
